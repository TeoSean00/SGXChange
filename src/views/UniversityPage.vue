<template>
    <div class="container-fluid">
        ...
        <div class="row mb-5">
            <div class="col-1"></div>
            <div class="col-6">
                <img src="../assets/440px-University_of_St._Gallen_EUR-HSG_Institute_Building.jpg" class="w-100" style="" alt="uni-display">
            </div>
            <div class="col-2">
                <img src="../assets/440px-University_of_St._Gallen_Convention_and_Executive_Education_Center.jpg" class="w-100 mb-2" alt="">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                ...
                <span class="me-2"><i class="bi bi-book m-1"></i> Historical cGPA: 3.21</span>
                <!-- Academic window -->
                <span class="mx-2"><i class="bi bi-calendar4-week m-1"></i>Academic Window: Sep'23 - Dec'23</span>
                <!-- Climate  -->
                <span class="mx-2"><i class="bi bi-thermometer-half m-1"></i>Climate: Cool</span>
            </div>
            <div class="col-1"></div>
        </div>
        <!-- hr filler -->
        ...
        <div class="row">
            ...
            <div class="col">
                <ul style="list-style-type: none;">
                    ...
                    <li class="my-4"><i style="font-size:2rem;" class="bi bi-house-door me-4"></i>Accommodation provided</li>
                    <!-- distance -->
                    <li class="my-4"><i style="font-size:2rem;" class="bi bi-airplane me-4"></i>Proximity: ~3500km</li>
                    <!-- Language spoken -->
                    <li class="my-4"><i style="font-size:2rem;" class="bi bi-translate me-4"></i>Language: English, Portugese, Spanish</li>
                </ul>
            </div>
            <div class="col-1"></div>
        </div>
            ...
            <div class="col">
                ...
                <div class="card my-4" style="width: 30rem;">
                    <div class="card-body">
                        ...
                        <!-- mod description -->
                        <p class="card-text">this module teaches you about the in depth of technical analysis and predictive modelling</p>
