<template>
  <h2 style="margin-left: 8rem; margin-right: 8rem">Module Mapping</h2>
  ...
  <div class="container" style="margin-left: 8rem; margin-right: 8rem">
    <div :class="{ formDisplay: form1 }">
      <!-- Step one -->
      <!-- Select Uni -->
      <div class="mb-3">
        <label for="uniInput" class="form-label"
      ...
      <!-- Select FIrst Degree -->
      <div class="mb-3">
        <label for="degreeInput" class="form-label"
          >Which Degree are you taking?</label
        >
        <select class="form-control" id="degreeInput" v-model="selectedDegree">
      ...
      <div class="mb-3">
        <label for="secondDegreeInput" class="form-label"
